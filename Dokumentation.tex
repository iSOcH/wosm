...
Wir zeigen hier die möglichen Reports, welche das Tool generieren kann. Der erste Report in Abbildung \ref{fig:anzahl_hosts} ist eine Statistik über die Anzahl Netze, VLANs und Hosts.
\begin{figure}[H]
\centering
