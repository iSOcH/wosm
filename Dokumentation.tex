...
\begin{longtable}{p{1.5cm}|p{3cm}|p{4.5cm}|p{4cm}}
...
\begin{description}
	...
	\item[Interne Hosts] dynamisches NAT overload: interner Range: 10.0.0.0 255.255.0.0 - öffentliche IP 209.165.50.1 (Outside IF IP der Firewall)
\end{description}
