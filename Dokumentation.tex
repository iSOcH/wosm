...
\label{gestio-ipv6-discovery-snmp}
...
\lstinputlisting{Phase3/netzinfo_via_snmp.txt}
...
\subsection{Fazit}
Unser Test von GestioIP und der Vergleich der Funktionalität mit anderen frei verfügbaren IP-Address-Management-Tools hat gezeigt, dass die freie Software in diesem Bereich noch einige Probleme aufweist und unausgereift erscheint.

Die in der Aufgabenstellung geforderten Funktionalitäten (z.B. \glqq{}Verwaltung aller verwendeten IP-Adressen (Zuteilung, Erneuerung, Rücknahme, Sperrung etc.\grqq{} oder \glqq{}Differenzierte Rechteverwaltung für die Verwendung des IPAM-Tools\grqq{}) erfüllt gemäss unseren Recherchen keines der frei verfügbaren Tools. Bei den visuell ansprechenderen Werkzeugen handelt es sich teilweise auch um reine Datenbanken, die über überhaupt keine Anbindung an die Infrastruktur für die Adressvergabe verfügen.

GestioIP haben wir auch deshalb ausgewählt, weil wir uns durch die versprochene Unterstützung von SNMP erhofft haben, die aktuelle Nutzung der vorhandenen Adressbereiche jeweils aktuell darstellen zu können. Die in Abschnitt \ref{gestio-ipv6-discovery-snmp} beschriebenen Probleme haben uns, neben anderen Einschränkungen, dann aber enttäuscht.

Insgesamt kommen wir zum Schluss, dass die freien IP-Adress-Management-Werkzeuge für grosse Umgebungen untauglich erscheinen und zu kostenpflichtigen Alternativen gegriffen werden muss. In kleinen Umgebungen hingegen werden sie kaum zum Einsatz kommen, da der Nutzen von IPAM mit einem separaten Werkzeug für eine geringe Anzahl von Adressen und Adressbereichen den Aufwand nicht rechtfertigt.
